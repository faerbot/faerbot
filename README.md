...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf faerbot && rm -rf .telegram-cli && git clone https://github.com/faerbot/faerbot.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
